	...
	const relayMessage = async (
		...
		await authState.keys.transaction(async () => {
			...
			if (isGroup || isStatus) {
				...
				if (!participant) {
					...
					if (!isStatus) {
						additionalAttributes = {
							...additionalAttributes,
							// eslint-disable-next-line camelcase
							addressing_mode: (groupData === null || groupData === void 0 ?
								void 0 :
				...
				// Message edit
				if (
					(_b = message.protocolMessage) === null || _b === void 0 ?
					void 0 :
					_b.editedMessage
				) {
					msgId =
						(_c = message.protocolMessage.key) === null || _c === void 0 ?
						void 0 :
						_c.id;
				...
				// Message delete
				if (
					((_d = message.protocolMessage) === null || _d === void 0 ?
						void 0 :
						_d.type) === WAProto_1.proto.Message.ProtocolMessage.Type.REVOKE
				) {
					msgId =
						(_e = message.protocolMessage.key) === null || _e === void 0 ?
						void 0 :
						_e.id;
					message = {};
				}
				...
				for (const {
					...
					const jid = (0, WABinary_1.jidEncode)(
						isMe && isLid ?
						((_g =
								(_f = authState.creds) === null || _f === void 0 ?
								void 0 :
								_f.me) === null || _g === void 0 ?
							void 0 :
							_g.lid.split(":")[0]) || user :
						user,
			...
			if (participants.length) {
				if (
					...
					const peerNode =
						(_j =
							(_h = participants[0]) === null || _h === void 0 ?
							void 0 :
							_h.content) === null || _j === void 0 ?
						void 0 :
						_j[0];
					if (peerNode) {
			...
			if (participant) {
				if ((0, WABinary_1.isJidGroup)(destinationJid)) {
					ows.attrs.to = destinationJid;
					ows.attrs.participant = participant.jid;
				} else if ((0, WABinary_1.areJidsSameUser)(participant.jid, meId)) {
					ows.attrs.to = participant.jid;
					ows.attrs.recipient = destinationJid;
				} else {
					ows.attrs.to = participant.jid;
				}
			} else {
				...
				if (
					((_l =
							(_k =
								...
								void 0 :
								message.viewOnceMessage) === null || _k === void 0 ?
							void 0 :
							_k.message) === null || _l === void 0 ?
						void 0 :
						_l.interactiveMessage) ||
					((_o =
							(_m =
								message === null || message === void 0 ?
								void 0 :
								message.viewOnceMessageV2) === null || _m === void 0 ?
							void 0 :
							_m.message) === null || _o === void 0 ?
						void 0 :
						_o.interactiveMessage) ||
					((_q =
							(_p =
								message === null || message === void 0 ?
								void 0 :
								message.viewOnceMessageV2Extension) === null || _p === void 0 ?
							void 0 :
							_p.message) === null || _q === void 0 ?
						void 0 :
						_q.interactiveMessage) ||
					(message === null || message === void 0 ?
						void 0 :
					...
					((_s =
							(_r =
								message === null || message === void 0 ?
								void 0 :
								message.viewOnceMessage) === null || _r === void 0 ?
							void 0 :
							_r.message) === null || _s === void 0 ?
						void 0 :
						_s.buttonsMessage) ||
					((_u =
							(_t =
								message === null || message === void 0 ?
								void 0 :
								message.viewOnceMessageV2) === null || _t === void 0 ?
							void 0 :
							_t.message) === null || _u === void 0 ?
						void 0 :
						_u.buttonsMessage) ||
					((_w =
							(_v =
								message === null || message === void 0 ?
								void 0 :
								message.viewOnceMessageV2Extension) === null || _v === void 0 ?
							void 0 :
					...
					message === null || message === void 0 ? void 0 : message.listMessage
				) {
	...
	return {
								...
								if (
									...
									throw new boom_1.Boom(
										`Media re-upload failed by device (${resultStr})`, {
											data: media,
											statusCode: (0, Utils_1.getStatusCodeForMediaRetry)(media.result) ||
												404,
										}
									);
								}
		...
		sendMessage: async (jid, content, options = {}) => {
			...
			if (typeof content === "object" && "album" in content && content.album) {
				...
				let mediaHandle;
				let mediaMsg;
				const albumMsg = (0, Utils_1.generateWAMessageFromContent)(
					jid, {
						albumMessage: {
							expectedImageCount: album.filter((item) => "image" in item)
								.length,
							expectedVideoCount: album.filter((item) => "video" in item)
								.length,
						},
					}, {
						userJid,
				...
				for (const i in album) {
					const media = album[i];
					if ("image" in media) {
						mediaMsg = await (0, Utils_1.generateWAMessage)(
							jid, {
								image: media.image,
								...(media.caption ? {
				...
				const fullMsg = await (0, Utils_1.generateWAMessage)(jid, content, {
					...
					messageId: (0, Utils_1.generateMessageIDV2)(
						(_c = sock.user) === null || _c === void 0 ? void 0 : _c.id
					),
					...options,
				});
				...
				if (isDeleteMsg) {
					...
					if (
						((0, WABinary_1.isJidGroup)(content.delete.remoteJid) &&
					...
					additionalAttributes.edit = (0, WABinary_1.isJidNewsletter)(jid) ?
						"3" :
						"1";
