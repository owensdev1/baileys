...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            const Msg = (0, Utils_1.normalizeMessageContent)(message);
            const key = (0, Utils_1.getContentType)(Msg);
            if (!isNewsletter && ((key === 'interactiveMessage' && ((_g = Msg === null || Msg === void 0 ? void 0 : Msg.interactiveMessage) === null || _g === void 0 ? void 0 : _g.nativeFlowMessage)) || key === 'buttonsMessage')) {
                const nativeNode = {
                    tag: 'biz',
                    attrs: {},
                    content: [{
