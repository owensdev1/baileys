...
const xmppSignedPreKey = (key) => ({
    ...
    content: [{
            tag: 'id',
            attrs: {},
            content: generics_1.encodeBigEndian(key.keyId, 3)
        },
        {
            tag: 'value',
            attrs: {},
...
const xmppPreKey = (pair, id) => ({
    ...
    content: [{
            tag: 'id',
            attrs: {},
            content: generics_1.encodeBigEndian(id, 3)
        },
        {
            tag: 'value',
            attrs: {},
...
const getNextPreKeysNode = async (state, count) => {
    ...
    const node = {
        ...
        content: [{
                tag: 'registration',
                attrs: {},
                content: generics_1.encodeBigEndian(creds.registrationId)
            },
            {
                tag: 'type',
                attrs: {},
